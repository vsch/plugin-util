...
class RectangleTest {
    ...
    @Test
    fun test_round() {
        val rect1 = Rectangle.of(10.4f, 30.4f, 20.4f, 50.4f)
        val rect2 = Rectangle.of(10.4f, 29.5f, 20.4f, 49.5f)
        val rect3 = Rectangle.of(9.5f, 30.4f, 19.5f, 50.4f)
        val rect4 = Rectangle.of(9.5f, 29.5f, 19.5f, 49.5f)
    ...
    fun test_basicInvertedXY() {
        val rect1 = Rectangle.of(30, 10, 50, 20)
    ...
    fun test_basicInvertedY() {
        val rect1 = Rectangle.of(10, 30, 50, 20)
    ...
    fun test_basicInvertedX() {
        val rect1 = Rectangle.of(30, 10, 20, 50)
    ...
    fun test_grow4() {
        ...
        val rect1_0001 = Rectangle.of(10, 30, 20, 50 + 1)
        val rect1_0010 = Rectangle.of(10, 30, 20 - 1, 50)
        val rect1_0100 = Rectangle.of(10, 30 + 1, 20, 50)
        val rect1_1000 = Rectangle.of(10 - 1, 30, 20, 50)
    ...
    fun test_scale1() {
        ...
        val rect1_01 = Rectangle.of(10 * 3, 30 * 3, 20 * 3, 50 * 3)
