...
class CheckeredBackgroundTransformTest : ImageTest() {

    val DARK_CHECKER = Color(0xCCCCCC)

    @Test
    fun test_transImage() {
        val trans = CheckeredBackgroundTransform(4, DARK_CHECKER, Color.BLACK)
    ...
    fun test_Image1() {
        val name = "Image1"
        val trans = TransparencyTransform(Color(0xE8FCE3), 4)
        val checkers = CheckeredBackgroundTransform(2, DARK_CHECKER, Color.WHITE)
        val image = getSourceImage("Image1")
        val actual = checkers.transform(trans.transform(image))
    ...
    fun test_Image2() {
        val name = "Image2"
        val trans = TransparencyTransform(Color(0xE8FCE3), 4)
        val checkers = CheckeredBackgroundTransform(3, DARK_CHECKER, Color.WHITE)
        val image = getSourceImage("Image1")
        val actual = checkers.transform(trans.transform(image))
        assertImagesEqual("Cropped", name, actual)
    }
    ...
    fun test_Image3() {
        val name = "Image3"
        val trans = TransparencyTransform(Color(0xE8FCE3), 4)
        val checkers = CheckeredBackgroundTransform(4, DARK_CHECKER, Color.WHITE)
        val image = getSourceImage("Image1")
        val actual = checkers.transform(trans.transform(image))
        assertImagesEqual("Cropped", name, actual)
    }
    ...
    fun test_Image4() {
        val name = "Image4"
        val trans = TransparencyTransform(Color(0xE8FCE3), 4)
        val checkers = CheckeredBackgroundTransform(5, DARK_CHECKER, Color.WHITE)
        val image = getSourceImage("Image1")
        val actual = checkers.transform(trans.transform(image))
        assertImagesEqual("Cropped", name, actual)
    }
    ...
    fun test_Image5() {
        val name = "Image5"
        val trans = TransparencyTransform(Color(0xE8FCE3), 4)
        val checkers = CheckeredBackgroundTransform(6, DARK_CHECKER, Color.WHITE)
        val image = getSourceImage("Image1")
        val actual = checkers.transform(trans.transform(image))
        assertImagesEqual("Cropped", name, actual)
    }
    ...
    fun test_Image6() {
        val name = "Image6"
        val trans = TransparencyTransform(Color(0xE8FCE3), 4)
        val checkers = CheckeredBackgroundTransform(8, DARK_CHECKER, Color.WHITE)
        val image = getSourceImage("Image1")
        val actual = checkers.transform(trans.transform(image))
        assertImagesEqual("Cropped", name, actual)
    }
