...
public abstract class LineRangeHighlightProviderBase<T> extends HighlightProviderBase<T> implements LineRangeHighlightProvider<T> {
    ...
    @Override
    public LineRangeHighlighter<T> getHighlighter(@NotNull final Editor editor) {
    ...
    @Override
    @Nullable
    public abstract TextAttributes getHighlightAttributes(final int index, final int flags, final int startOffset, final int endOffset, final @Nullable Color foregroundColor, final @Nullable Color effectColor, final @Nullable EffectType effectType, final int fontType);
}
