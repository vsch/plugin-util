...
public abstract class SettingsComponents<T> implements SettingsConfigurable<T>, Disposable {
    ...
    @NotNull public <V> SpinnerSetter<V> component(@NotNull JSpinner component, @NotNull Getter<V> getter, @NotNull Setter<V> setter) { return new SpinnerSetter<>(component, getter, setter); }
